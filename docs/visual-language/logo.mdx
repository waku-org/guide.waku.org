...
<div style={{display: "flex", gap: "16px"}}>
  <AssetCard
    title="Mark - Black"
    forceDownload
    previewSrc="/logo/Mark/Large/PREVIEW-Waku-Mark-Black-Large.png"
    downloadable={[
      {
        title: "PNG",
        src: "/logo/Mark/Large/Waku-Mark-Black-Large.png"
      },
      {
        title: "SVG",
        src: "/logo/Mark/Large/Waku-Mark-Black-Large.svg"
      }
    ]}
  />
  ...
  <AssetCard
    title="Mark - White"
    forceDownload
    previewSrc="/logo/Mark/Large/PREVIEW-Waku-Mark-White-Large.png"
    downloadable={[
      {
        title: "PNG",
        src: "/logo/Mark/Large/Waku-Mark-White-Large.png"
      },
      {
        title: "SVG",
        src: "/logo/Mark/Large/Waku-Mark-White-Large.svg"
      }
    ]}
  />
</div>
...
<div style={{display: "flex", gap: "16px"}}>
  <AssetCard
    ...
    forceDownload
    previewSrc="/logo/Vertical lockup/Large/PREVIEW-Waku-Vertical-lockup-Black-Large.png"
    downloadable={[
      {
        title: "PNG",
        src: "/logo/Vertical lockup/Large/Waku-Vertical lockup-Black-Large.png"
      },
      {
        title: "SVG",
        src: "/logo/Vertical lockup/Large/Waku-Vertical lockup-Black-Large.svg"
      }
    ]}
  />
  ...
  <AssetCard
    ...
    forceDownload
    previewSrc="/logo/Vertical lockup/Large/PREVIEW-Waku-Vertical-lockup-White-Large.png"
    downloadable={[
      {
        title: "PNG",
        src: "/logo/Vertical lockup/Large/Waku-Vertical lockup-White-Large.png"
      },
      {
        title: "SVG",
        src: "/logo/Vertical lockup/Large/Waku-Vertical lockup-White-Large.svg"
      }
    ]}
  />
</div>
...
<div style={{display: "flex", gap: "16px"}}>
  <AssetCard
    ...
    forceDownload
    previewSrc="/logo/Horizontal lockup/Large/PREVIEW-Waku-Horizontal lockup-Black-Large.png"
    downloadable={[
      {
        title: "PNG",
        src: "/logo/Horizontal lockup/Large/Waku-Horizontal lockup-Black-Large.png"
      },
      {
        title: "SVG",
        src: "/logo/Horizontal lockup/Large/Waku-Horizontal lockup-Black-Large.svg"
      }
    ]}
  />
  ...
  <AssetCard
    ...
    forceDownload
    previewSrc="/logo/Horizontal lockup/Large/PREVIEW-Waku-Horizontal lockup-White-Large.png"
    downloadable={[
      {
        title: "PNG",
        src: "/logo/Horizontal lockup/Large/Waku-Horizontal lockup-White-Large.png"
      },
      {
        title: "SVG",
        src: "/logo/Horizontal lockup/Large/Waku-Horizontal lockup-White-Large.svg"
      }
    ]}
  />
</div>
